...
class _PublicityState extends State<Publicity> {
  ...
  var _values=[false,false,false,false,false,false,false,false,false,false,false,false];
 ...
 final size = MediaQuery.of(context).size;
    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<List<PublicityMethods>> snapshot) {  
        if ( snapshot.hasData ) {
          ...
          itemBuilder: (context, i) => _createCheckBox(context,productos[i],i)
            ));
          }
  ...
  Widget  _createCheckBox(BuildContext context,PublicityMethods prod, int index){
