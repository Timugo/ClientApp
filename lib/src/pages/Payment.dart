...
class Payment extends StatelessWidget {
  ...
  void addPrincipal(String value){
    final prefs = new PreferenciasUsuario();  //this function add the principal address of user
      ...
      builder: (BuildContext context, AsyncSnapshot<List<NequiModel>> snapshot) {
        if ( snapshot.hasData ) {
          ...
          return  ListView.builder(
            ...
            addPrincipal: ()=> addPrincipal('Nequi'),
        ...
        builder: (BuildContext context, AsyncSnapshot<List<CardModel>> snapshot) {
          if ( snapshot.hasData ) {
            ...
            return  ListView.builder(
              ...
              addPrincipal: ()=> addPrincipal('Card')
              , producto: productos[i],)
