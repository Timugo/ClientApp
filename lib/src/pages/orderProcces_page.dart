      ...
      body:Stack( 
        children:<Widget>[
          Container(
           ...
           Container(
            padding:EdgeInsets.only(left: size.width*0.04,top:size.height*0.1) ,
          ...
          Container(
           ...
           Container(
            margin:  EdgeInsets.only(left: size.width*0.04, right: size.width*0.04,top:size.height*0.35),
            child: Divider(
              color: Colors.black,
          ...
          Container(
            padding:EdgeInsets.only(left: size.width*0.04,top: size.height*0.38) ,
            child:Text("Resumen de Orden",style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold)),
          ),
          Container(
            padding: EdgeInsets.only(top:size.height*0.42,bottom: size.height*0.08),
            alignment: Alignment.bottomCenter,
            child:_crearListado()
          )
        ]
