        ...
        children:<Widget>[
          ...
          decoration: BoxDecoration(
           ...
           borderRadius: BorderRadius.only(
            ...
            child:Row(
              children: <Widget>[
                Text("Mi perfil",style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold)),
                Spacer(),
                CircleAvatar(
                  radius:50,
          ...
          children: <Widget>[
            MyTextFormField(
               ...
               MyTextFormField(
                ...
                text: Icon(Icons.email,color: Colors.red,),
...
class MyTextFormField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final size = MediaQuery.of(context).size;
    return Padding(
      padding: EdgeInsets.only(left:size.width*0.02,right: size.width*0.02,bottom:10,top: size.width*0.05),
      child: TextFormField(
