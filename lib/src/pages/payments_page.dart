...
import 'package:timugo/src/pages/payments/nequi_page.dart';
import 'package:timugo/src/pages/payments/pse_page.dart';
...
class Payment extends StatelessWidget {
    ...
    return Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            _createMethods(context, 'PSE', false, 'assets/images/BotonPSE.png',
                PSEpayment()),
            _createCard(),
            _createCardNequi(),
            Container(
            ...
            Flexible(
                child: Column(
              children: <Widget>[
                _createMethods(context, 'Tarjeta de crédito o débito', true,
                    'solidCreditCard', CreditCardH()),
                _createMethods(context, 'Nequi ', false,
                    'assets/images/Nequi.png', NequiPage()),
              ],
            ))
          ],
        ));
  ...
  Widget _createMethods(BuildContext context, String texto, bool icon,
      String image, dynamic ruta) {
    return Card(
        margin: EdgeInsets.only(left: 15, right: 15, top: 10),
  ...
  Widget _createCardNequi() {
    ...
    return FutureBuilder(
      ...
      builder:
          (BuildContext context, AsyncSnapshot<List<NequiModel>> snapshot) {
        if (snapshot.hasData) {
...
class ListTileItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
        ...
        child: Ink(
            decoration: BoxDecoration(
                gradient: producto.favorite == false
            ...
            child: ListTile(
                ...
                subtitle: Text('**************' + producto.last4Numbers,
                    style: TextStyle(
                        color: color,
                        fontSize: 15,
                        fontWeight: FontWeight.bold)),
                leading: _chooseCard(producto.brand, color),
                trailing: producto.favorite
                    ? Icon(
    ...
    return Card(
      ...
      child: Ink(
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20.0)),
        child: ListTile(
          title: Text(producto.phone,
              style: TextStyle(color: color, fontWeight: FontWeight.bold)),
          leading: Image(
            image: AssetImage('assets/images/Nequi.png'),
            width: 55,
          ),
          subtitle: Text(producto.type,
              style: TextStyle(
                color: color,
              )),
          trailing: producto.favorite
